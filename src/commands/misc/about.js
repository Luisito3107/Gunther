    ...
    async execute(ctx, client) {
        ...
        ctx.reply({embeds: [new EmbedBuilder()
            ...
            .setFields([
                ...
                { name: "\u200b", value: `Using [Laffey](https://github.com/Weeb-Devs/Laffey) bot from [Weeb-Devs](https://github.com/Weeb-Devs) as a canvas, Gunther bot was bot created as a replacement for the beloved Groovy bot for *Tomemos el té* and *Los weones* servers, but with some extra goodies such as Genius lyrics, YouTube~Discord watch parties and a lot of audio filters (effects).`+
                `\nThis bot was created in memory of [James Michael Tyler](https://en.wikipedia.org/wiki/James_Michael_Tyler), who played the role of [Gunther](https://friends.fandom.com/wiki/Gunther) on the sitcom [Friends](https://en.wikipedia.org/wiki/Friends) (my favorite show) and passed away from cancer in October 2021. However, for versatility this bot uses images of Gunter, the penguin that always accompanies the Ice King in Adventure Time.`, inline: false },
            ])
        ]})
    }
}